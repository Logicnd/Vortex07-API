import { startBind } from "../../../../lib/economy.js";
...
export async function POST(request) {
  ...
  try {
    const result = await startBind(discordId);
    return json(result);
  } catch (err) {
    console.error("economy bind start failed", err);
